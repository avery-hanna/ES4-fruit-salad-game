...
global para
set para(gui_mode) 1
set para(prj_dir) "Z:/final-proj/ES4-fruit-salad-game"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o fruitSalad_impl_1_syn.udb fruitSalad_impl_1.vm] "Z:/final-proj/ES4-fruit-salad-game/impl_1/fruitSalad_impl_1.ldc"
